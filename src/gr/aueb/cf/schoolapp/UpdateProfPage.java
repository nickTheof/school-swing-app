	...
	public UpdateProfPage() {
		addWindowListener(new WindowAdapter() {
			...
			public void windowActivated(WindowEvent e) {
				...
				fetchTeacherFromDatabase(Main.getViewProfsPage().getSelectedUUID());
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try (PreparedStatement ps = conn.prepareStatement(sql)) {
					...
					ps.setInt(10, cityId);
					ps.setString(11, Main.getViewProfsPage().getSelectedUUID());
		...
		private void fetchTeacherFromDatabase(String uuid) {
			...
			try (PreparedStatement ps = conn.prepareStatement(sql)) {
				...
				while (rs.next()) {
					...
					vatField.setText(rs.getString("vat"));
					phoneField.setText(rs.getString("phone_num"));
					addressField.setText(rs.getString("street"));
					lastnameField.setText(rs.getString("lastname"));
					fatherNameField.setText(rs.getString("fathername"));
					mailField.setText(rs.getString("email"));
					streetNoField.setText(rs.getString("street_num"));
					postalCodeField.setText(rs.getString("zipcode"));
